...
print("NASDAQ: AMD",  stock_price_from_market_watch("NASDAQ: AMD",  False))
print("MSFT",  stock_price_from_market_watch("MSFT",  False))
print("NASDAQ: FB",   stock_price_from_market_watch("NASDAQ: FB",   False))
print("NASDAQ: AMZN",  stock_price_from_market_watch("NASDAQ: AMZN",  False))
print("NASDAQ: GOOGL",    stock_price_from_market_watch("NASDAQ: GOOGL",    False))
print("APG1L",  stock_price_from_market_watch("APG1L",  False))
print("EXS1", stock_price_from_market_watch("EXS1", True))
print("EXSA",  stock_price_from_market_watch("EXSA",  True))
print("SPYD",  stock_price_from_market_watch("SPYD",  False))
print("SPYW", stock_price_from_market_watch("SPYW", True))
